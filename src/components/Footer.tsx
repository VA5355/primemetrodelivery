...
const Footer =() =>{
    const primecomputersmall = "/logo_dark_small.png";
    ...
    <div className="w-full h-20 bg-amazon_light text-gray-400 flex items-center justify-center gap-4">
        <Image className="w-16" src={primecomputersmall} alt="Logo"  width={35}
      height={25}/> <Image className="w-48 px-4 object-cover "  src={primecomputertext}  width={150}
