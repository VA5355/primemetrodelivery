    ...
    return(
        <div className="flex flex-col p-2 gap-4">
            ...
            <p className="flex items-center justify-between px-2 font-semibold">Total Price: {" "}
                ...
                <button onClick={handleCheckout} className="w-85% p-2 h-10 text-sm font-semibold bg-amazon_yellow  text-black rounded-lg hover:bg-amazon_blue hover:text-white duration-300">
            Proceed to Checkout
          </button>
                        ...
                        <div className="flex flex-col items-center">
                <button className="w-85% p-2 h-10 text-sm font-semibold bg-amazon_blue bg-opacity-50 text-white rounded-lg cursor-not-allowed">
            Proceed to Checkout
          </button>
